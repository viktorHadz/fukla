...
export const Footer = () => {
  const footerNavigation = {
    main: [
      ...
      { name: 'Адрес', href: 'https://goo.gl/maps/JyPuf91ztik3HE1r8' },
      { name: 'Начало', href: '/' },
      { name: 'Плитки', href: '/braids' },
      { name: 'Нокти', href: '/nails' },
      { name: 'Работно време', component: true },
    ],
    social: [
      {
        name: 'Facebook',
  ...
  return (
    ...
    //   </div>
    // </footer>
    <footer className='px-6 pb-20 mx-auto mt-40 overflow-hidden max-w-7xl sm:mt-64 sm:pb-24 lg:px-8 bg-slate-900'>
      <nav
        ...
        {footerNavigation.main.map((item) =>
          item.component ? (
            <div key={item.name} className='pb-6'>
              <DialogPopUp
                buttonClass='text-sm leading-6 text-gray-600 hover:text-gray-900'
...
// <footer className='px-6 pb-20 mx-auto mt-40 overflow-hidden max-w-7xl sm:mt-64 sm:pb-24 lg:px-8'>
//   <nav
//     className='-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12'
//     aria-label='Footer'
//   >
