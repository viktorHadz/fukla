          ...
          <div className='w-full max-w-2xl -mt-8 xl:-mb-8 xl:w-96 xl:flex-none'>
            <div className='relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto'>
              <img
                ...
                src='/images/braids/aboutUsBanner.webp'
                alt=''
              />
            </div>
          </div>
            ...
            <figure className='relative pt-6 isolate sm:pt-12'>
              ...
              <blockquote className='text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9'>
                <p>
                  ...
                  уникални прически – от класически плитки до сложни стилизирани
                  форми. Вярваме, че косата разказва история, и целта ни е да ви
                  помогнем да изразите своя стил по неповторим начин. За нас
                  плитките не са просто прическа – те са начин да покажете себе
                  си.
                </p>
              </blockquote>
