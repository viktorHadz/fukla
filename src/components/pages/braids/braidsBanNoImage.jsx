        ...
        <div className='px-6 mx-auto mt-32 max-w-7xl sm:mt-56 lg:px-8'>
          <div className='max-w-2xl mx-auto lg:text-center'>
            <h2 className='text-base font-semibold leading-7 text-[#e95d7a]'>
              Перфектният избор за всяка визия
            </h2>
            <p className='mt-2 text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl'>
              Открийте стил, който подчертава вашата уникалност.
            </p>
            <p className='mt-6 text-lg leading-8 text-gray-600'>
              Всяка плитка е повече от прическа – тя е израз на вашата
              индивидуалност. Създаваме визии, които комбинират елегантност и
              практичност, за да се чувствате уверени и красиви всеки ден.
            </p>
          </div>
              ...
              {features.map((feature) => (
                <div key={feature.name} className='relative pl-16'>
                  <dt className='text-base font-semibold leading-7 text-zinc-900'>
                    <div className='absolute top-0 left-0 flex items-center justify-center w-12 h-12 bg-[#e95d7a] rounded-lg'>
                      <feature.icon
