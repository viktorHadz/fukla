  ...
  return (
    ...
    >
      ...
      <SwiperSlide key={url} className="braidsportfolio__container">
          <img
            className="braidsportfolio__img"
            src={url}
            alt="Portfolio"
          />
      </SwiperSlide>
    ...
    <div className="braidsportfolio__btn">
      <Link to='/gallery' state={{ folder: "makeup" }} className="braidsportfolio__gallery">Цялостна галерия</Link>
    </div>
    </>
  );
};