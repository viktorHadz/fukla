...
export const NailsBanner = () => {
  const handleScroll = () => {
    scrollToElement('nails-welcome');
  };
  return (
    <div className='w-full h-[400px] md:h-[400px] lg:h-[600px] bg-zinc-950 relative overflow-hidden mt-20 cursor-default'>
