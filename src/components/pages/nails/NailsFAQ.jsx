...
const faqs = [
  ...
  {
    question: '6. Мога ли да запазя час онлайн?',
    answer: (
      <span>
        Да, можете да запазите час чрез нашия профил в{' '}
        <a
  ...
  {
    question: '7. Подходящо ли е изграждането за слаби нокти?',
    answer:
      'Да, изграждането укрепва слаби нокти, като предоставя дълготрайно и красиво решение.',
  },
  {
    question: '8. Можете ли да препоръчате грижа за педикюр у дома?',
    answer:
