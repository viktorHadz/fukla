export const TattooAboutMe = () => {
  return (
    <section className='px-6 mt-32 overflow-hidden bg-white isolate lg:px-8'>
        ...
        <figure className='grid items-center grid-cols-1 gap-x-6 gap-y-8 lg:gap-x-10'>
          <div className='relative col-span-2 lg:col-start-1 lg:row-start-2'>
            ...
            <blockquote className='text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9'>
              <p>
                Аз съм Галиана и се занимавам професионално с маникюр и педикюр
                повече от 3 години. Това не е просто работа за мен – това е
                моята страст, моят талант и моето вдъхновение! Ако искате да
                изглеждате ослепително от глава до пети и да се потопите във
                вълшебството на моето изкуство, както и на целия ни екип,
                заповядайте при нас!
              </p>
            </blockquote>
          </div>
          <div className='w-16 col-end-1 lg:row-span-4 lg:w-72'>
            <img
          ...
          <figcaption className='text-base lg:col-start-1 lg:row-start-3'>
            <div className='font-semibold text-gray-900'>Галиана</div>
          </figcaption>
        </figure>
      </div>
    </section>
